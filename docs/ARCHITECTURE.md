...
- **Post-game reset** — [`resetToLobby()`](https://github.com/s1ryx/skipbo/blob/0309671/server/gameLogic.js#L365-L378)
...
- Delegates rendering to sub-components:
  ...
  - [`GameOverOverlay`](https://github.com/s1ryx/skipbo/blob/b102cb7/client/src/components/GameOverOverlay.js) (52 lines) — winner + a countdown-gated return-to-room button
